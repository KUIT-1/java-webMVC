...
<div class="container" id="main">
    <div class="col-md-12 col-sm-12 col-lg-10 col-lg-offset-1">
        ...
        %>
            <form name="question" method="post" action="/qna/change?questionId=${q.questionId}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="${q.title}" id="title" name="title" placeholder="제목"/>
                </div>
                <div class="form-group">
                    <label for="contents">내용</label>
                    <textarea name="contents" id="contents" rows="5" class="form-control">${q.contents}</textarea>
                </div>
