        ...
        <div class="qna-list">
            <ul class="list">
                    ...
                    <div class="wrap">
                        <div class="main">
                            <strong class="subject">
                                <a href="../webapp/qna/show.jsp"> 객체지향에서 가장 중요하다고 생각하는 것이 무엇인가요? </a>
                            </strong>
                            <div class="auth-info">
                ...
                <li>
                    <div class="wrap">
                        <div class="main">
                            <strong class="subject">
                                <a href="../webapp/qna/show.jsp"> 동아리에 시간 얼마나 투자할 수 있는지? </a>
                            </strong>
                            <div class="auth-info">
                                <i class="icon-add-comment"></i>
            ...
            <div class="row">
                ...
                <div class="col-md-2 qna-write">
                    <a href="../webapp/qna/form.jsp" class="btn btn-primary pull-right" role="button">질문하기</a>
                </div>
            </div>
        </div>
    </div>
